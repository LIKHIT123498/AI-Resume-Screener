...
async def upload_and_screen_resumes(
    ...
    for file in files:
        try:
            ...
            # Safely extract sub-scores generated by the AI
            ...
            # Determine candidate name, fallback to clean filename if missing
            name_val = evaluation.get("name")
            if not name_val or str(name_val).strip() in ("", "None", "null", "Candidate Name"):
                # Clean up filename (e.g. "John_Doe_Resume.pdf" -> "John Doe Resume")
